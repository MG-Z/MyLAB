...
//        analyze();
    ...
    public static void analyze() {
        ...
        try {
            Class<?> c = Class.forName("com.structural.proxy.DynamicProxyCGLib$TargetCGLib$$EnhancerByCGLIB$$f9c5d708");
            Class<?> beanc = Class.forName("com.structural.proxy.DynamicProxyCGLib$TargetCGLib");
